...
public class level2 implements Screen {
    ...
    public void show() {
        ...
        texture = new Texture("l2bg.jpg");  // Background texture
    ...
    public void render(float delta) {
        ...
        batch.draw(catapult, 1, 100, 150, 100);  // Adjust width and height as needed
        batch.draw(red, 1, 100, 60, 60);
        batch.draw(black, 160, 100, 60, 60);
        batch.draw(yellow, 100, 100, 60, 60);
        batch.end();
    }
