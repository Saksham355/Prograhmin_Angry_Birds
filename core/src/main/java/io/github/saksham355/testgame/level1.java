...
public class level1 implements Screen {
    ...
    public void show() {
        ...
        texture = new Texture("l1bg.jpg");  // Background texture
    ...
    public void render(float delta) {
        ...
        batch.draw(catapult, 1, 150, 150, 100);  // Adjust width and height as needed

        batch.draw(red, 1, 150, 60, 60);
        batch.draw(black, 160, 150, 60, 60);
        batch.draw(yellow, 100, 150, 60, 60);
        batch.end();
    }
